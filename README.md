...
- 🎭 Beautiful UI transitions and effects
...
- **Form Handling**: Custom implementation with Telegram integration
- **Development**: Vite
...
3. Get your chat ID
4. Configure the environment variables in Supabase
...
- Telegram integration for messages
