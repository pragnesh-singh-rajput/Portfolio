    ...
    <section ref={sectionRef} id="blog" className="py-20 relative">
      <div className="container mx-auto px-6">
        ...
        <div className={`mt-16 text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ animationDelay: '1.2s' }}>
          <a href="https://shivablogs.tech/" target="_blank" rel="noopener noreferrer" className="inline-block professional-border px-8 py-4 text-tech-blue hover:text-white hover:bg-tech-blue/10 transition-all duration-300 font-medium hover-lift group">
