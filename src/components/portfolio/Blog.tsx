...
export const Blog = () => {
  ...
  <a
    href="https://shivablogs.tech/"
    target="_blank"
    rel="noopener noreferrer"
    className="inline-block professional-border px-8 py-4 text-tech-blue hover:text-white hover:bg-tech-blue/10 transition-all duration-300 font-medium hover-lift group"
  >
